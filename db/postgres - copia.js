...
function parseConnectionString(connectionString) {
    ...
    try {
        ...
        return {
            ...
            ssl: toBoolean(url.searchParams.get('ssl')) || ['require','verify-ca','verify-full','prefer','allow'].includes(url.searchParams.get('sslmode')?.toLowerCase() || '') || connectionString.includes('render.com'),
        };
    } catch {
        return null;
    }
...
export function getDatabaseConfig() {
    ...
    if (isProduction && envConfig) {
        ...
        source = 'sin-configurar';
    }

    return { source, config: effective };
}
